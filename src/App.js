    ...
    <div>
      <header>
        <Navbar className="dark-green-background" bg="success" variant="dark">
          <Container>
            <Navbar.Brand href="mailto:nanarov123@gmail.com?subject=Job&body=Hi Maxim, We've seen your portfolio and we'd liked to discussed with you!">
              <svg
            ...
            <Navbar.Brand href="tel:+972-058-559-9369">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
